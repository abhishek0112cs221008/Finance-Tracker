...
class _SettingsScreenState extends State<SettingsScreen> {
        ...
        actions: options.map((option) {
          return CupertinoActionSheetAction(
            onPressed: () {
              ...
              _updateSetting(title.toLowerCase().replaceAll(' ', ''), option);
            },
            child: Text(
              option,
              style: TextStyle(
                ...
                children: [
                  _buildCupertinoSwitchTile(
                    ...
                    onChanged: (val) {
                      ...
                      _updateSetting('isDarkTheme', val);
                    },
                  ),
                  _buildCupertinoSwitchTile(
  ...
  Widget _buildCupertinoTile({
    ...
    return CupertinoListTile(
      ...
      onTap: onTap,
      trailing: hasTrailing ? const CupertinoListTileChevron() : null,
    );
  }
  ...
  Widget _buildCupertinoSwitchTile({
    ...
    return CupertinoListTile(
      ...
      onTap: () => onChanged(!value), // Tap the whole row to toggle
    );
  }
}

// Helper widget to provide the iOS chevron icon, which is missing in your original code.
