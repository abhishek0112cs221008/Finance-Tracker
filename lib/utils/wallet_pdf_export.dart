...
class WalletPdfExporter {
  static Future<void> exportTransactions({
        ...
        build: (context) => [
              ...
              ...transactions.take(20).map((t) {
                return pw.TableRow(
                  children: [
                    ...
                    _buildTableCell(t.isIncome ? 'Income' : 'Expense'),
          ...
          pw.Container(
            ...
            child: pw.Row(
              ...
              children: [
                pw.Text(
                  'Generated by Finance Tracker PRO',
                  style: pw.TextStyle(
                    fontSize: 10,
                    color: PdfColors.white,
                    fontWeight: pw.FontWeight.bold,
    ...
    await Printing.layoutPdf(
      ...
      name: 'FinanceTracker_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
